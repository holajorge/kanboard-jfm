...
class TaskCreationModel extends Base
{
    ...
    protected function prepare(array &$values)
    {
        ...
        $this->helper->model->resetFields($values, array('creator_id', 'owner_id', 'date_due', 'date_started', 'score','hola','mundo', 'category_id', 'time_estimated', 'time_spent'));
        ...
        $values['hola'] = $values['hola'];
        $values['mundo'] = $values['mundo'];
